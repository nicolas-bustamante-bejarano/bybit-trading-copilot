"use client";
import { Activity, BookOpen, ChartNoAxesCombined, FlaskConical, LayoutDashboard, ListTree, Radar, Server, ShieldCheck } from "lucide-react";
import Link from "next/link";
import { usePathname } from "next/navigation";
import type { ReactNode } from "react";
const links = [
  ["/workspace", "Workspace", ChartNoAxesCombined], ["/scanner", "Scanner", Radar], ["/", "Dashboard", LayoutDashboard], ["/positions", "Positions", Activity], ["/trade-plans", "Trade Plans", ListTree],
