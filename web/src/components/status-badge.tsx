...
const tones: Record<string, string> = {
  ...
  INFO: "border-cyan-400/30 bg-cyan-400/10 text-cyan-200", WARNING: "border-amber-400/40 bg-amber-400/10 text-amber-200", CRITICAL: "border-red-500/50 bg-red-500/15 text-red-200",
};
